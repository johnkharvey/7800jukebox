...
out/jukebox.bin:	src/jukebox.asm src/pokeymusic.asm src/macros_pokey.asm src/music_*.asm ${DASM} out
	echo "\n###### Creating jukebox.bin... ######"
	${DASM} src/jukebox.asm -f3 -oout/jukebox.bin -sout/jukebox.symbol.txt -lout/jukebox.annotated_source.txt

out/jukebox.a78:	src/cartridge_header_jukebox.asm out/jukebox.bin ${7800SIGN} out
	echo "\n###### Signing jukebox.bin... ######"
	${7800SIGN} -w out/jukebox.bin
	echo "\n\n###### Creating jukebox.a78... ######"
	${DASM} src/cartridge_header_jukebox.asm -f3 -oout/jukebox.a78
...
run:	${A7800}
	cd bin/a7800 && ./a7800 a7800 -cart ../../out/jukebox.a78

debug:	${A7800}
	cd bin/a7800 && ./a7800 a7800 -cart ../../out/jukebox.a78 -debug
