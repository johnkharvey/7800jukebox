...
; Uses pokey_notes column H (brown)
  ...
  ELSE
	...
	;================
        ...
        dc.b    #$33, #12, #VOL04_CONST ; C
        dc.b    #$00, #4,  #RESTDEFAULT ; rest
        dc.b    #$25, #9,  #VOL04_CONST ; F
        dc.b    #$00, #3,  #RESTDEFAULT ; rest
        dc.b    #$21, #9,  #VOL04_CONST ; G
        dc.b    #$00, #3,  #RESTDEFAULT ; rest

        ; Uses pokey_notes column H (brown)
        dc.b    #$33, #48, #VOL04REST02 ; C
