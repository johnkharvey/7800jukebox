...
;TOTAL: 18+12+18+12+12

	; Uses pokey_notes column P (green)
        ;dc.b    #$7E, #144, #VOL04_CONST ; C
        ;dc.b    #$7E, #144, #VOL04_CONST ; E
        ;dc.b    #$7E, #144, #VOL04_CONST ; G
        ;dc.b    #$7E, #144, #VOL04_CONST ; G
        ;dc.b    #$7E, #144, #VOL04_CONST ; G
        ;dc.b    #$7E, #144, #VOL04_CONST ; F
        ;dc.b    #$7E, #144, #VOL04_CONST ; E

        ;dc.b    #$7E, #144, #VOL04_CONST ; F
        ;dc.b    #$7E, #144, #VOL04_CONST ; A
        ;dc.b    #$7E, #144, #VOL04_CONST ; C
        ;dc.b    #$7E, #144, #VOL04_CONST ; C
        ;dc.b    #$7E, #144, #VOL04_CONST ; C
